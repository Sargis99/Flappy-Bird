(function() {
 ...
 var render = c.getContext("2d");
    ...
    //Նկարներ քցելը  
    var bgImg = loadImage('Images/background.jpg', 640, 480),
        playerImg = loadImage('https://blog.threadless.com/blog/wp-content/uploads/2016/02/flappybird.png', 192, 64),
        enemyUpImg = loadImage('Images/enemy_up.png', 64, 316),
        enemyDownImg = loadImage('Images/enemy_down.png', 64, 316);
        
    var pointAudio = new Audio('Images/point.mp3'),
        loseAudio = new Audio('Images/lose.mp3');

    //Նկարին ֆունկցիա որտեղ ստանում է սորսը երկարությունը, բարձրությունը
    ...
    function draw() {
        ...
        if (!GAME_PLAYING) {
            ...
            ctx.strokeText('Click to start game', c.width / 2 - 230, 240);
            ctx.fillStyle = 'rgba(255,255,255,' + textAlpha.get() + ')';
            ctx.fillText('Click to start game', c.width / 2 - 230, 240);
            textAlpha.fluctuate();
        }
